module Debounce.Debounce exposing
    ( debounce
    , debounce1
    , debounceCmd
    , init
...
1.  Extend Msg with a wrapper message that will be routed to Debounce module.
...
1.  Configure the debounce component using `Debounce.config`
...
import Debounce.Helpers as Helpers
import Debug
import Process
import Task
